...
#
# TechnoCorps, a Discord bot by Lesterleal, based on discord.py and its command
#                             extension.
#
...
description = "TechnoCorps - A Roblox Discord bot by Lesterleal Join SCD Now And TC"
...
class Bot(commands.Bot):
    ...
    async def shutdown(self, *, restart=False):
        """Gracefully quits TechnoCorps with exit code 0

        If restart is True, the exit code will be 26 instead
        The launcher automatically restarts TechnoCorps when that happens"""
...
def interactive_setup(settings):
    ...
    if first_run:
        print("TechnoCorps - First run configuration\n")
